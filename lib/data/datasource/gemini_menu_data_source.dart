...
class GeminiMenuDataSource {
  ...
  Map<String, dynamic> _buildRequestBody(List<Ingredient> ingredients) {
    ...
    final prompt =
        ...
        '목록에 없는 재료는 쓰지 마라. 요리를 처음 해보는 사람도 그대로 '
        '따라 할 수 있도록 조리 순서를 상세히 적어라. 각 단계마다 그 '
        '단계에서 쓰는 재료의 분량(예: 양파 1/2개, 간장 1큰술, 물 200ml)과 '
        '화력·시간(예: 중불에서 3분, 끓을 때까지)을 구체적인 숫자로 '
        '넣어라. "적당히", "알맞게" 같은 모호한 표현은 쓰지 마라.\n\n'
        '$ingredientLines';
